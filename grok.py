...
from llama-index.embeddings.gemini import GeminiEmbedding # <-- IMPORTACIÓN NUEVA
...
def cargar_y_crear_indice(_ruta_a_cargar, _llm_model, _chunk_size, _chunk_overlap):
    ...
    Settings.embed_model = GeminiEmbedding(
        model_name="models/embedding-001", # El modelo de embedding estándar de Gemini
        api_key=google_api_key # <-- CAMBIO
    )
    ...
    # NOTA: Si cambias de modelo de embedding, DEBES borrar la carpeta 
    # 'storage_vectorial' local y de GitHub para forzar la re-indexación.
